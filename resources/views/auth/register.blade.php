    ...
    <div class="container">
      <div class="row join-row">
        <div class="col-md-12  probootstrap-animate" style="z-index: 9">
          <form id="rForm" action="/store" method="post"
                class="probootstrap-form probootstrap-form-box mb60 text-center">
            {{--            <h4 class="mb-5">회원가입</h4>--}}
            <a class="col-md-12 navbar-brand mb-3" href="/"><img
                src="//cloudfront.mo-zip.co.kr/mo-zip/images/logo-black.svg"
            ...
            <div class="sign-up-box text-left">
              <p class="login-info-text m-0">회원가입을 함으로써 모집의 <a class="sign-up underline login-sub-text text-highlight"
                                                               name="btn-join" href="{{ url('/agreement') }}"
                                                               target="_blank">이용약관</a>, <a
                  class="sign-up underline login-sub-text text-highlight" name="btn-join" href="{{ url('/privacy') }}"
                  target="_blank">개인정보보호정책</a> 에 동의하시게 됩니다.</p>
            </div>
