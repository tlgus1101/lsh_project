            ...
            <div class="card p-4" style="margin: auto">
              ...
              <?php if($data->reservation_payment_way =="무통장입금" ): ?>
                <div class="detail-title"><span class="float-eft">계좌번호 / 은행 / 예금주</span><span
                    class="float-right detail-contents"><?php echo e($contract->partner_contract_accountnumber." / ".$contract->partner_contract_bank." / ".$contract->partner_contract_accountholder); ?></span>
                </div>
              ...
              <div class="detail-title"><span class="float-left">이용인원</span><span
                  class="float-right detail-contents"><?php echo e($data->reservation_people_add_information); ?></span>
              </div>
              <?php if($data->reservation_extra_information): ?>
              <div class="detail-title"><span class="float-left">부가서비스</span><span
                  class="float-right detail-contents"><?php echo e($data->reservation_extra_information); ?></span>
              </div>
              <?php endif; ?>
              ...
              <?php endif; ?>
              <div class="black-line"></div>
              <div class="detail_info"><span><i class="fa fa-info-circle" aria-hidden="true"></i> 예약시 입력한 휴대폰번호 <?php echo e($data->reservation_orderer_contact); ?> 은(는) 안심번호로 숙소에 전달되며, 퇴실 후 5일간 보관됩니다.</span>
              </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/isihyeon/Documents/GitHub/mo-zip/resources/views/product/reserveconfirm.blade.php ENDPATH**/ ?>