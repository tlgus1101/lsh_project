...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'MOZ!P | 모든예약집합소!'); ?></title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="probootstrap-menu">
      <ul class="navbar-nav ml-auto">
        <?php if(Auth::check()): ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/reservation')); ?>">예약내역</a></li>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/information')); ?>">내 정보</a></li>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/logout')); ?>">로그아웃</a></li>
        <?php else: ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/login')); ?>">예약내역</a></li>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/login')); ?>">로그인</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
      ...
      <div class="top">
        <div class="footerInfo-container">
          ...
          <div class="footerInfo-c-item-2">
            ...
            <div><a href="<?php echo e(url('/agreement')); ?>" target="_blank">이용약관</a></div>
            <div><a href="<?php echo e(url('/privacy')); ?>" target="_blank">개인정보처리방침</a></div>
          </div>
      ...
      <div>
        <div class="footer-userref" style="background-color: transparent;">
          <div class="footer-btn mr-1">
            <a class="btn btn-primary text w-100" href="<?php echo e(url('/agreement')); ?>" target="_blank">이용약관</a>
          </div>
          <div class="footer-btn">
            <a class="btn btn-primary text w-100" href="<?php echo e(url('/privacy')); ?>" target="_blank">개인정보처리방침</a>
          </div>
        </div>
      </div>
    </div>
...
<script>
  <?php if(Auth::check()): ?>
  <?php if(Auth::user()->email == "" || Auth::user()->contact == ""): ?>
  $("#email").val("<?php echo e(Auth::user()->email); ?>");
  $("#contact").val("<?php echo e(Auth::user()->contact); ?>");
...
<?php /**PATH /Users/isihyeon/Documents/GitHub/lsh_project/resources/views/layouts/layout.blade.php ENDPATH**/ ?>