      ...
      $(function () {
          ...
          if ("<?php echo e($sido); ?>" != "") {
              ...
              if (sessionStorage.getItem('sido') != "") {
                  ...
                  $("#sido").val("<?php echo e($sido); ?>");
                  $("#gu").val("<?php echo e($sigungu); ?>");
                  $("#sido_gu").html("<?php echo e($sido); ?>" + " - " + "<?php echo e($sigungu); ?>");
                  roomAjax(sessionStorage.getItem('type'), sessionStorage.getItem('idx'), "<?php echo e($sido); ?>", "<?php echo e($sigungu); ?>");
                  var url = "url('//cloudfront.mo-zip.co.kr/mo-zip/images/" + dg["<?php echo e($sido); ?>"] + "')";
                  $("#section-home").css("background-image", url);
              }
              ...
              $("#section-home").css("background-image", url);
              roomAjax("<?php echo e($type); ?>", sessionStorage.getItem('idx'), $("#sido").val(), $("#gu").val());
          }
          ThumbnailOpacity();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/isihyeon/Documents/GitHub/lsh_project/resources/views/product/community.blade.php ENDPATH**/ ?>