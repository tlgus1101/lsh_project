      ...
      <div class="row join-row">
        <div class="col-md-12  probootstrap-animate" style="z-index: 9">
          <form class="probootstrap-form probootstrap-form-box mb60 text-center">
            ...
            <a class="col-md-12 navbar-brand mt-3" href="/" ><img src="//cloudfront.mo-zip.co.kr/mo-zip/images/logo-black.svg"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/isihyeon/Documents/GitHub/mo-zip/resources/views/auth/verify.blade.php ENDPATH**/ ?>