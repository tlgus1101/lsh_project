  ...
  <section class="probootstrap_section bg-light">
    <form action="/reserve/save" method="post" onsubmit="return checked();" id="insertFrom">
      ...
      <input type="hidden" id="reservation_type" name="reservation_type"
             value="<?php echo e($room->room_product_sale_type); ?>">
      <input type="hidden" id="reservation_use_start_date" name="reservation_use_start_date"
             value="<?php echo e(date('Y-m-d', strtotime($in))); ?>">
      <input type="hidden" id="reservation_use_end_date" name="reservation_use_end_date"
             value="<?php echo e(date('Y-m-d', strtotime($out))); ?>">
      <?php if($room->room_product_sale_type == "대실"): ?>
        <input type="hidden" id="reservation_use_time" name="reservation_use_time"
               value="<?php echo e($room->room_renting_use_time); ?>시간">
      <?php elseif($room->room_product_sale_type == "대여"): ?>
        <input type="hidden" id="reservation_use_time" name="reservation_use_time"
               value="<?php echo e($room->room_rent_use_time); ?>시간">
      <?php else: ?>
        <input type="hidden" id="reservation_use_time" name="reservation_use_time"
               value="<?php echo e($diff_date = (strtotime($out) - strtotime($in)) / 86400); ?>박">
      <?php endif; ?>
      ...
      <input type="hidden" id="add_adult" name="add_adult" value="<?php echo e($room->room_standard_people); ?>">
      ...
      <input type="hidden" id="max_people" name="max_people" value="<?php echo e($room->room_maximum_people); ?>">
      <input type="hidden" id="room_standard_people" name="room_standard_people"
             value="<?php echo e($room->room_standard_people); ?>">
      ...
      <div class="container">
            ...
            <div class="col-12 probootstrap-animate text-center">
              ...
              <div class="probootstrap-form probootstrap-form-box mb60">
                ...
                <span class="contents ml-3 float-right display-6">최대 <span
                    class="text-red display-5"><?php echo e($room->room_renting_use_time); ?>시간</span> 이용 가능</span><span
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="select_time">
                      <?php for($i=$room->room_renting_use_start_date  , $j = 1 ;$i<=$room->room_renting_use_end_date ;$i++ ,$j++): ?>
                        <div class="time">
                          <?php if($i<10): ?>
                            <div class="time">
                              <input class="time" type="checkbox" name="time"
                                     id="time<?php echo e($i); ?>" onclick="timeclick('<?php echo e($i); ?>')">
                              <label for="time<?php echo e($i); ?>">0<?php echo e($i); ?>:00</label>
                            </div>
                          <?php else: ?>
                            <div class="time">
                              <input class="time" type="checkbox" name="time"
                                     id="time<?php echo e($i); ?>" onclick="timeclick('<?php echo e($i); ?>')">
                              <label for="time<?php echo e($i); ?>"><?php echo e($i); ?>:00</label>
                            </div>
                          <?php endif; ?>
                        </div>
                      <?php endfor; ?>
            ...
            <div class="col-12 probootstrap-animate text-center">
              ...
              <div class="probootstrap-form probootstrap-form-box mb60">
                <div class="row mb-4">
                  <div class="col-12">
                <span class="contents ml-3 float-right display-6">최대 <span
                    class="text-red display-5"><?php echo e($room->room_rent_use_time); ?>시간</span> 이용 가능</span><span
                      class="m-0 float-right">이용시간 </span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="select_time">
                      <?php for($i=$room->room_rent_use_start_date  , $j = 1 ;$i<=$room->room_rent_use_end_date ;$i++ ,$j++): ?>
                        <div class="time">
                          <?php if($i<10): ?>
                            <div class="time">
                              <input class="time" type="checkbox" name="time"
        ...
        <div class="row">
          ...
          <div class="col-md-5 probootstrap-animate text-center">
            ...
            <div class="probootstrap-form probootstrap-form-box mb60 text-left">
              <p class="m-0">숙소이름</p>
              <p class="contents"><?php echo e($partner->name); ?></p>
              <p class="m-0">객실정보/ 기간</p>
              <?php if($room->room_product_sale_type == "대실"): ?>
                <p class="contents div-line"><?php echo e($room->room_name); ?> / <span
                    id="ck_time"><?php echo e($room->room_renting_use_time); ?></span>
                  시간</p>
              <?php elseif($room->room_product_sale_type == "대여"): ?>
                <p class="contents div-line"><?php echo e($room->room_name); ?> / <span
                    id="ck_time"><?php echo e($room->room_rent_use_time); ?></span>
                  시간</p>
              <?php else: ?>
                <p class="contents div-line"><?php echo e($room->room_name); ?>

                  / <?php echo e($diff_date = (strtotime($out) - strtotime($in)) / 86400); ?>
        ...
        <div class="row">
          <?php if( $room->room_product_extra_whether == 'true' && Count($extras) > 0): ?>
            <?php if( $room->room_product_people_add_whether == 'true' && Count($addpeople) > 0): ?>
                        ...
                        <?php $__currentLoopData = $extras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="swiper-slide">
                            <div class="media probootstrap-media d-block align-items-stretch probootstrap-animate">
                              <img src="<?php echo e($extra->room_extra_route . $extra->room_extra_save_name); ?>"
                              ...
                              <div class="input-group count-group">
                                <div class="input-group-append">
                                  <button type="button" class="btn btn-secondary count-left active"
                                          name="extra_minus_<?php echo e($extra->room_extra_idx); ?>"
                                          id="extra_minus_<?php echo e($extra->room_extra_idx); ?>" value="0"
                                          onclick="extraClick('<?php echo e($extra->room_extra_idx); ?>','-','<?php echo e($extra->room_extra_name); ?>','<?php echo e($extra->room_extra_price); ?>')"
                                          disabled
                                  ><i class="fa fa-minus" aria-hidden="true"></i></button>
                                </div>
                                <input class="form-control count-span" value="0"
                                       id="extra<?php echo e($extra->room_extra_idx); ?>" name="extra<?php echo e($extra->room_extra_idx); ?>"
                                       readonly>
                                <div class="input-group-append">
                                  <button type="button" class="btn btn-secondary count-right active"
                                          name="extra_plus_<?php echo e($extra->room_extra_idx); ?>"
                                          id="extra_plus_<?php echo e($extra->room_extra_idx); ?>"
                                          value="<?php echo e($extra->room_extra_quantity); ?>"
                                          onclick="extraClick('<?php echo e($extra->room_extra_idx); ?>','+','<?php echo e($extra->room_extra_name); ?>','<?php echo e($extra->room_extra_price); ?>')">
                                    <i class="fa fa-plus" aria-hidden="true"></i></button>
                                </div>
                              </div>
                              <span class=""><?php echo e($extra->room_extra_name); ?></span>
                              <span class=""> ( <?php echo e(number_format($extra->room_extra_price)); ?> 원) </span>
                            </div>
                          </div>
                              ...
                              <div class="row mb-4">
                                <div class="col-12">
                                  <span class="contents ml-3 float-right display-6">최대
                                    <span class="text-red display-5"><?php echo e($room->room_maximum_people); ?>명</span> 이용 가능
                                  </span>
                                </div>
                              </div>
                              <?php $__currentLoopData = $addpeople; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $people): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($people->room_people_add_name == "성인"): ?>
                                  <div class="row mb-4" style="margin: auto;">
                                    <div class="col-12 count-contents">
                                      ...
                                      <div class="input-group count-group">
                                        ...
                                        <input class="form-control count-span" value="<?php echo e($room->room_standard_people); ?>"
                                        ...
                                        <input type="hidden"
                                               value="<?php echo e($people->room_people_add_price); ?>"
                                               id="adult_price">
                                      </div>
                                    </div>
                                  </div>
                                <?php elseif($people->room_people_add_name == "아동"): ?>
                        ...
                        <div class="col-md-5 probootstrap-animate text-center">
                          ...
                          <div class="probootstrap-form probootstrap-form-box mb60 text-left">
                            ...
                            <p class="price div-line"><span
                                id="all_price"><?php echo e(number_format($room->sum_price)); ?></span>원
                            ...
                            <div class="container detail-section" id="detail">
                              <p class="mb-2">+ 상품가격
                                <span> <?php echo e(number_format($room->room_product_price + $room->room_product_add_price)); ?></span>원
                              </p>
                              <p class="mb-2 text-red">-
                                할인금액 <?php echo e(number_format($room->room_product_discount_price)); ?>원</p>
...
<?php $__env->startSection('scripts'); ?>
  ...
  <script>
      ...
      $(function () {
          $("#detail").hide();
          if ("<?php echo e($room->room_product_sale_type); ?>" != "숙박") {
            <?php $__currentLoopData = $selectTime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            $("#time" + "<?php echo e($time); ?>").attr("disabled", true);
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          }
          var yoil = ["일", "월", "화", "수", "목", "금", "토"];
          $("#re_in").html('<?php echo e(date('Y.m.d', strtotime($in))); ?>' + " (" + yoil[new Date('<?php echo e(date('Y.m.d', strtotime($in))); ?>').getDay()] + ")");
          $("#re_out").html('<?php echo e(date('Y.m.d', strtotime($out))); ?>' + " (" + yoil[new Date('<?php echo e(date('Y.m.d', strtotime($out))); ?>').getDay()] + ")");
          ...
          $(".list-group-item").on("click", function (e) {
              ...
              if ($(this).children("input[name = pay]").val() == "카드결제") {
                  ...
                  $("#pay_detail").html("<span class='text-red'> 입급계좌정보   &nbsp&nbsp&nbsp    <?php echo e($contract->partner_contract_accountnumber." / ".$contract->partner_contract_bank." / ".$contract->partner_contract_accountholder); ?></span>");
              } else {
      ...
      function timeclick(id) {
          timeClick = 0;
          if ("<?php echo e($room->room_product_sale_type); ?>" == "대실") {
            <?php for($i =$room->room_renting_use_start_date ; $i <$room->room_renting_use_end_date+1 ; $i++): ?>
            $("#time" + "<?php echo e($i); ?>").prop("checked", false);
            <?php endfor; ?>
              <?php for($i = 0; $i <$room->room_renting_use_time; $i++): ?>
            if ($("#time" + (Number(id) + <?php echo e($i); ?>)).prop("disabled") == false) {
                $("#time" + (Number(id) + <?php echo e($i); ?>)).prop("checked", true);
                timeClick++;
            }
            <?php endfor; ?>
          } else {
            <?php for($i = $room->room_rent_use_start_date; $i < $room->room_rent_use_end_date+1; $i++): ?>
            $("#time" + "<?php echo e($i); ?>").prop("checked", false);
            <?php endfor; ?>
              <?php for($i = 0; $i <$room->room_rent_use_time; $i++): ?>
            if ($("#time" + (Number(id) + <?php echo e($i); ?>)).prop("disabled") == false) {
                $("#time" + (Number(id) + <?php echo e($i); ?>)).prop("checked", true);
                timeClick++;
            }
          ...
          $("#reservation_use_start_date").val('<?php echo e(date('Y-m-d', strtotime($in))); ?>' + " " + (Number(id)) + ":00");
          $("#reservation_use_end_date").val('<?php echo e(date('Y-m-d', strtotime($out))); ?>' + " " + (Number(id) + timeClick) + ":00");

          var yoil = ["일", "월", "화", "수", "목", "금", "토"];
          $("#re_in").html('<?php echo e(date('Y.m.d', strtotime($in))); ?>' + " (" + yoil[new Date('<?php echo e(date('Y.m.d', strtotime($in))); ?>').getDay()] + ")" + " " + (Number(id)) + ":00");
          $("#re_out").html('<?php echo e(date('Y.m.d', strtotime($out))); ?>' + " (" + yoil[new Date('<?php echo e(date('Y.m.d', strtotime($out))); ?>').getDay()] + ")" + " " + (Number(id) + timeClick) + ":00");
      }
      ...
      function myInfo() {//내정보 불러오기 클릭시
          $("#reservation_orderer_name").val("<?php echo e(Auth::user()->name); ?>");
          $("#reservation_orderer_contact").val("<?php echo e(Auth::user()->contact); ?>");
      }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/isihyeon/Documents/GitHub/mo-zip/resources/views/product/reserve.blade.php ENDPATH**/ ?>